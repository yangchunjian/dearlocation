...
<a href="https://mp.weixin.qq.com/s/RWkc2lNarKnn8Dc0HrP58g" target="_blank" rel="noopener noreferrer">https://mp.weixin.qq.com/s/RWkc2lNarKnn8Dc0HrP58g<ExternalLinkIcon/></a></p>
<hr>
<h2 id="_1-mysql有哪几种log" tabindex="-1"><a class="header-anchor" href="#_1-mysql有哪几种log" aria-hidden="true">#</a> 1. mysql有哪几种log</h2>
...
<hr>
<h2 id="_2-mysql的复制原理以及流程" tabindex="-1"><a class="header-anchor" href="#_2-mysql的复制原理以及流程" aria-hidden="true">#</a> 2. MySQL的复制原理以及流程</h2>
<ol>
...
<hr>
<h2 id="_3-事物的4种隔离级别" tabindex="-1"><a class="header-anchor" href="#_3-事物的4种隔离级别" aria-hidden="true">#</a> 3. 事物的4种隔离级别</h2>
<p>隔离强度逐渐增强，性能逐渐变差。</p>
<ul>
...
<hr>
<h2 id="_4-相关概念" tabindex="-1"><a class="header-anchor" href="#_4-相关概念" aria-hidden="true">#</a> 4. 相关概念</h2>
...
<hr>
<h2 id="_5-mysql数据库几个基本的索引类型" tabindex="-1"><a class="header-anchor" href="#_5-mysql数据库几个基本的索引类型" aria-hidden="true">#</a> 5. MySQL数据库几个基本的索引类型</h2>
<p>普通索引、唯一索引、主键索引、全文索引</p>
<hr>
<h2 id="_6-drop、delete与truncate的区" tabindex="-1"><a class="header-anchor" href="#_6-drop、delete与truncate的区" aria-hidden="true">#</a> 6. drop、delete与truncate的区</h2>
...
<hr>
<h2 id="_7-数据库的乐观锁和悲观锁是什么" tabindex="-1"><a class="header-anchor" href="#_7-数据库的乐观锁和悲观锁是什么" aria-hidden="true">#</a> 7. 数据库的乐观锁和悲观锁是什么？</h2>
...
<hr>
<h2 id="_8-sql优化方式" tabindex="-1"><a class="header-anchor" href="#_8-sql优化方式" aria-hidden="true">#</a> 8. SQL优化方式</h2>
<ol>
...
<hr>
<h2 id="_9-从锁的类别上分mysql都有哪些锁呢" tabindex="-1"><a class="header-anchor" href="#_9-从锁的类别上分mysql都有哪些锁呢" aria-hidden="true">#</a> 9. 从锁的类别上分MySQL都有哪些锁呢？</h2>
